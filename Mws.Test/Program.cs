...
using MarketplaceWebService.Sellers.Model;
...
namespace Mws.Test
{
    ...
    public class MarketplaceWebServiceSellersSample
    {
        ...
        public static void Main(string[] args)
        {
            ...
            IMarketplaceWebServiceSellers client = new MarketplaceWebServiceSellersClient(accessKey, secretKey, appName, appVersion, config);
        ...
        private readonly IMarketplaceWebServiceSellers client;

        public MarketplaceWebServiceSellersSample(IMarketplaceWebServiceSellers client)
        {
            this.client = client;
        }
